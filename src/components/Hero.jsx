...
const Hero = () => {
  // make back backgournd video difrent then waht is transitioning in

  // gsap scroll trigger pulgin
        ...
        >
          ...
          <div className="absolute left-0 top-0 z-40 size-full">
            <div className="mt-24 px-5 sm:px-10">
              ...
              <p className="mb-5 max-w-64 font-robort-regular text-blue-100">
