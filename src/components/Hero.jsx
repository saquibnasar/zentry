      ...
      <div className="relative h-dvh w-screen overflow-x-hidden">
        ...
        >
          ...
          <video
            ...
            muted
            id="next-video"
            className="absolute-center invisible absolute z-20 size-64 orign-center object-cover object-center"
            onLoadedData={handleVideoLoad}
          />
          <video
            ref={nextVideoRef}
            ...
            autoPlay
            id="next-video"
            className="solute left-0 top-0 size-full orign-center object-cover object-center"
            onLoadedData={handleVideoLoad}
          />
